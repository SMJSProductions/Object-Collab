...
namespace object_collab {
    ...
    public:
        ...
        static const Register& getRegister();
        /// @returns The inclusive base numeric ID constant used for custom object keys.
        static constexpr uint32_t getBaseCustomObjectID() { return ObjectAPI::BASE_CUSTOM_OBJECT_ID; }
        ...
        static std::optional<uint32_t> getCustomObjectNumericID(std::string_view objectID);
        ...
        static std::optional<std::string_view> getCustomObjectID(int numericID);
        ...
        static ObjectInfo* getCustomObject(std::string_view objectID);
        /// Looks up the object info of the given numeric ID.
        /// @param numericID The numeric ID under which the object is registered.
        /// @returns The found object info. A nullptr result means the object isn't registered.
        static ObjectInfo* getCustomObject(int numericID);
