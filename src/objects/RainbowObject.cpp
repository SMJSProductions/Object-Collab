...
CustomObject* RainbowObject::create() {
...
void RainbowObject::onAction() {
    ...
    GJBaseGameLayer* baseGameLayer = GJBaseGameLayer::get();
    
    baseGameLayer->m_player1->setColor(color1);
    baseGameLayer->m_player1->setSecondColor(color2);

    if (baseGameLayer->m_player2) {
        baseGameLayer->m_player1->setColor(color2);
        baseGameLayer->m_player1->setSecondColor(color1);
    }
}
